...
class CustomerLeadController extends Controller
{
    ...
    ';
            ...
            ->addColumn('view', function ($row)
            {
                ...
                <a  href="' . route("customer-leads.show", $row) . '" class="btn btn-sm btn-info btn-b"><i class="fa fa-eye" aria-hidden="true"></i>
        ...
        $company = Lead::select('companyName')->where('user_id',auth()->user()->id)->distinct()->get();
        return view('customer.leads.index',compact('company'));
    ...
    public function show($id)
    {
     ...
     $chat= ChatDetail::where('chat_id',$lead->chatId)->get();
      return view('customer.leads.viewLead', compact('lead','chat'));
    }
    ...
    public function edit($id)
    {
        ...
        $lead = Lead::find($id);
        return view('customer.leads.addEdit', compact('lead'));
    }
