...
(function(root, factory) {
    ...
    function notif(config) {
        ...
        // Available positions
        var available_positions = ['right', 'center', 'left', 'bottom'];
        // Default config
        var defaults = {
            type: "default",
            width: 400,
        ...
        defaults.animations.slide = {
            'center': {
                'css_start': {
                    ...
                    "right": mid - parseInt(defaults.width / 2)
                },
                'in': {
            ...
            if($confirm){
                if(settings.fullscreen){
                    ...
                    $confirm.css({
                        ...
                        'right': $bg.outerWidth() / 2 - ($confirm.outerWidth() / 2)
                    })
            ...
            if($prompt){
                if(settings.fullscreen){
                    ...
                    $prompt.css({
                        ...
                        'right': $bg.outerWidth() / 2 - ($prompt.outerWidth() / 2)
                    })
