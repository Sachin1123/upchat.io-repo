                  ...
                  <div class="form-group row">
                    ...
                    <select name="role"  class="form-control">
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input class="form-control" name="apex_company"  placeholder="Enter your apex company name" type="text" value="{{isset($user->company->apex_company) ? $user->company->apex_company : '' }}">
                        </div>
                      </div>
                      <div class="form-group row">
                        <label for="inputEmail3" class="col-sm-2 col-form-label">Apex Username</label>
                        <div class="col-sm-10">
                        <input class="form-control" name="apex_username"  placeholder="Enter your apex username" type="text" value="{{isset($user->company->apex_username) ? $user->company->apex_username : '' }}">
                        </div>
                      </div>
                      ...
                      <div class="form-group row">
                        ...
                        <div class="col-sm-10">
                        <input class="form-control" name="apex_password"  placeholder="Enter your password" type="text" value="{{isset($user->company->apex_password) ? $user->company->apex_password : '' }}" >
                        </div>
                      </div>
...
var editCustomer=$('select').children("option:selected").val();
