          ...
          <div class="col-md-3">
            ...
            <div class="card card-primary card-outline">
              <div class="card-body box-profile">
                ...
                @else
                <img class="profile-user-img img-fluid img-circle"
                            src="{{URL::asset('dist/img/user4-128x128.jpg')}}"
                            alt="User profile">
                @endif
            ...
            <div class="card">
              <div class="card-header p-2"style="display: block !important;">
                <ul class="nav nav-pills">
                  ...
                  <li class="nav-item"><a class="nav-link" href="#company_detail" data-toggle="tab">Update Company Detail</a></li>
              ...
              <div class="card-body">
                <div class="tab-content">
                  ...
                  <div class="tab-pane" id="settings">
                    <form class="form-horizontal" id="user-add-edit" action="{{route('customer-profile.store')}}" method="POST" enctype="multipart/form-data">
                    @csrf
                  ...
                  <div class="tab-pane" id="company_detail">
                    <form class="form-horizontal" id="change-password" action="{{route('companyDetails')}}" method="POST" enctype="multipart/form-data">
                      @csrf
