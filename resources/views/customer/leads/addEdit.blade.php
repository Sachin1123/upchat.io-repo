        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item"><a  class="btn btn-primary" href="{{ route('customer-leads.index') }}">View Leads</a></li> 
        ...
        <div class="row">
          <div class="col-12">
            <div class="card">
              ...
              <!-- /.card-header -->
              <div class="card-body">
              <form class="form-horizontal" id="user-add-edit" action="{{isset($lead) ? route('customer-leads.update',$lead->id) : route('customer-leads.store')}}" method="POST" enctype="multipart/form-data">
              @csrf
