        ...
        <div class="row mb-2">
          ...
          <div class="col-sm-6">
            <ol class="breadcrumb float-sm-right">
              <li class="breadcrumb-item active"><a class="btn btn-primary" href="{{ route('customer-service-tickets.create') }}" >Add Services</a></li>
...
<script type="text/javascript">
    $(document).ready(function () {
      ...
      var Table = $('#datatable').DataTable({
            ...
            ajax: {
                url: "{{ route('customer-service-tickets.index') }}",
                    data: function(d) {
